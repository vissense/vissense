...
var PubSub = (function (undefined) {
  ...
  PubSub.prototype.publish = function (/*String*/ topic, args) {
    var me = this;
    var anyTopic = this._config.anyTopicName;
    var fireListeners = function (listenersOrNull, args) {
      var listeners = listenersOrNull || [];
      console.debug('publishing topic %s to %i listeners', topic, listeners.length);

      var listenerArgs = args || [];
      forEach(listeners, function (listener) {
        listener(listenerArgs);
      });
      if (topic !== anyTopic) {
        me.publish(anyTopic, args);
      }
    };

    return (!this._config.async ? fireListeners : async(fireListeners))(this._cache[topic], args);
  };
...
/**
 * @deprecated use `.on('update', ...)` instead
 * @method
 * @name onUpdate
 * @memberof VisSense.VisMon#
 *
...
/**
 * @deprecated use `.on('visibilitychange', ...)` instead
 * @method
...
/**
 * @deprecated use `.on('percentagechange', ...)` instead
 * @method
...
/**
 * @deprecated use `.on('visible', ...)` instead
 * @method
 * @name onVisible
 * @memberof VisSense.VisMon#
 *
...
/**
 * @deprecated use `.on('fullyvisible', ...)` instead
 * @method
 * @name onFullyVisible
 * @memberof VisSense.VisMon#
 *
...
/**
 * @deprecated use `.on('hidden', ...)` instead
 * @method
 * @name onHidden
 * @memberof VisSense.VisMon#
 *
