...
var PubSub = (function (undefined) {
  ...
  PubSub.prototype.publish = function (/*String*/ topic, args) {
    ...
    var fireListeners = function(listeners, args) {
    ...
    return !this._config.async ? fireListeners(listeners, args) : async(fireListeners)(listeners, args);
