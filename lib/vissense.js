 ...
 * @id VisSense
 * @name VisSense
 * @description A utility library for detecting visibility of DOM element
 *
 ...
 */
 ;(function (root, factory) {
     ...
     *
     * @description Assigns all properties of source object to the destination object
     * if they are not present in the destination object.
     * 
     * ```javascript
     * VisSense.Utils.defaults({ name: 'Max', gender: 'male' }, { name: 'Fred', age: 31 });
     ...
     *
     * ```javascript
     * VisSense.Utils.defer(function(stamp) { console.log('Hello world.'); });
     * // => true
     * ```
     */
     ...
     *
     * @description Assigns properties of source object to the destination object
     * (overwriting any existing values of the destination object).
     * 
     * ```javascript
     * VisSense.Utils.extend({ name: 'Max', age: 31 }, { name: 'Fred', gender: 'male' });
     * // => { name: 'Fred', age: 31, gender: 'male' }
     * ```
     */
    function extend(dest, source, callback) {
        ...
        while (++index < length) {
            var key = props[index];
            dest[key] = isFunction(callback) ? callback(dest[key], source[key], key, dest, source) : source[key];
        }
     ...
     * VisSense.Utils.isElement(VisSense);
     * // => true
     *
     * VisSense.Utils.isElement({});
     * // => false
     * ```
     */
